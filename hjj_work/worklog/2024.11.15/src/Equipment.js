...
wpn.fksrd.desc =
    'The sword is made of bamboo. Poorer ronin sometimes pretend to be full-fledged samurai with this' + dom.dseparator;
wpn.fksrd.slot = 1;
wpn.fksrd.str = 23;
wpn.fksrd.cls = [2, 0, 4];
...
wpn.tkmts.desc =
    'This reinforced sword is made of bamboo. Not much as a weapon, but makes you seem stronger' + dom.dseparator;
wpn.tkmts.slot = 1;
wpn.tkmts.str = 35;
wpn.tkmts.cls = [2, 1, 5];
...
wpn.sprw.name = 'Spear';
wpn.sprw.desc =
    "Long piece of wood with a sharp metal chunk at the end of it. Couldn't get simpler than that" + dom.dseparator;
wpn.sprw.slot = 1;
wpn.sprw.str = 11;
wpn.sprw.cls = [2, 4, 1];
wpn.sprw.ctype = 1;
...
eqp.gnt.desc =
    'Tough leather gauntlet that covers your entire hand. May prevent you from losing fingers' + dom.dseparator;
eqp.gnt.slot = 5;
eqp.gnt.str = 10;
eqp.gnt.stype = 3;
...
eqp.sndl.desc =
    "Cheap unremarkable sandals made from light leather. Aren't even that comfortable to wear" + dom.dseparator;
eqp.sndl.slot = 7;
eqp.sndl.str = 3;
eqp.sndl.agl = 1;
...
eqp.rnss.desc =
    "Simple shoes made from tree rubber. Sturdy and longlasting, they protect one's toes from cold" + dom.dseparator;
eqp.rnss.slot = 7;
eqp.rnss.str = 9;
eqp.rnss.agl = 2;
...
eqp.hkgd.desc =
    'A simple and light helmet that provides minimal protection against falling debris and the like' + dom.dseparator;
eqp.hkgd.str = 14;
eqp.hkgd.slot = 3;
eqp.hkgd.stype = 3;
...
eqp.wkss.desc =
    'Safety shoes for laborers. The metal reinforcement offers dependable protection for the toes' + dom.dseparator;
eqp.wkss.slot = 7;
eqp.wkss.str = 16;
eqp.wkss.agl = 2;
...
eqp.knkn.desc =
    "Long boots woven from linen. Light and breathable, so they're comfortable when it's hot" + dom.dseparator;
eqp.knkn.slot = 7;
eqp.knkn.str = 19;
eqp.knkn.agl = 2;
...
eqp.brbn.desc =
    'A long, hooded cloak. Protetcs the wearer from both the scorching sun and chilling cold' + dom.dseparator;
eqp.brbn.slot = 4;
eqp.brbn.str = 33;
eqp.brbn.agl = -4;
eqp.brbn.stype = 3;
...
eqp.ovrl.desc =
    'Work clothes made of heavy cloth that cover the entire body. Protects from bumps and scratches' + dom.dseparator;
eqp.ovrl.slot = 4;
eqp.ovrl.str = 25;
eqp.ovrl.stype = 3;
...
eqp.knkls.desc =
    'Leather bands that cover fingers' + dom.dseparator + 'Unarmed STR: <span style="color:lime">+4</span><br>';
eqp.knkls.slot = 5;
eqp.knkls.str = 4;
eqp.knkls.undc = 4;
...
sld.bkl.desc =
    'Tiny shield that is supposed to be strapped onto an arm. Low defence, but provides high mobility' + dom.dseparator;
sld.bkl.slot = 2;
sld.bkl.str = 5;
...
acc.qill.name = 'Quill';
acc.qill.desc =
    'Feather of a large bird, turned into a writing tool ' + dom.dseparator + '<span style="color:lime">AGL +5</span>';
acc.qill.slot = 8;
acc.qill.stype = 3;
...
acc.wdl1.oneq = function () {
    for (let afn = 0; afn < this.ccls.length; afn++) you.ccls[afn] += this.ccls[afn];
};
...
acc.hndm.desc =
    "A tuft of a fey hound's mane, said to ward off evil. It raises resistance to heat and cold" + dom.dseparator + '';
acc.hndm.slot = 8;
acc.hndm.stype = 3;
...
acc.dcpe.desc =
    "A mysterious gem. It feels like it's looking at something, but you can't really tell" + dom.dseparator + '';
acc.dcpe.slot = 8;
acc.dcpe.stype = 3;
...
acc.alseto.desc =
    'Wide variety of aberrant glassware and precision tools for all enums of entry level alchemy-based manipulations. A necessity for making basic medicine, pills, poisons, elixirs and everything inbetween' +
    dom.dseparator +
