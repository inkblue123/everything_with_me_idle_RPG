...
chss.trne1e1.sl = () => {
    ...
    global.lst_loc = 124;
    chs(
        "Instructor: Great job smashing that golem! This golem is one of the weakest enums around, but even he can become a huge trouble if you're not giving it your best. Now, grab this and proceed with your training",
        true
    );
