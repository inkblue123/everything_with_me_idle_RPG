...
//玩家主动技能放在战斗规划界面中，根据主动技能类型呈现不同的颜色
function init_active_skill_show_color(enums) {
    let id;
    //每种主动技能在战斗规划界面的展示颜色
    id = 'attack'; //攻击型
    add_Enum_Object(enums, id);
...
//游戏中的货币类型
function init_money_type(enums) {
    let id;
...
function init_Enum_type(enums) {
    ...
    //玩家主动技能放在战斗规划界面中，根据主动技能类型呈现不同的颜色
    init_active_skill_show_color(enums);
    //游戏事件的监控行为的类型
