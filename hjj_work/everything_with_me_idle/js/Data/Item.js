...
class Consumable extends Item {
    constructor(id, name, maxStack) {
        ...
        this.Consumable_type = new Object(); //这个消耗品的具体类型
    }
}
//材料通用属性
...
//武器装备
{
    //近战武器
    {
        ...
        items['wood_sword'].Equipment_type = ['sword'];
        ...
        items['wood_battle_axe'].type = ['weapon'];
        items['wood_battle_axe'].Equipment_type = ['battle_axe'];
...
//消耗品
{
    ...
    items['wood_arrow'].type = ['combat_CSB'];
    items['wood_arrow'].Consumable_type = ['arrow'];
}
export { items };
