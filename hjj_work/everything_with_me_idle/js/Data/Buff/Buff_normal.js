...
function init_normal_buff(buffs) {
    ...
    buffs[id].add_buff_value('only_start_restore', 'end_CLT_attack', -20); //采集力降低20%
    buffs[id].add_buff_value('only_start_restore', 'end_CLT_speed_num', -20); //采集速度延长20%
    ...
    buffs[id].add_buff_value('only_start_restore', 'end_CLT_attack', -50); //采集力降低50%
    buffs[id].add_buff_value('only_start_restore', 'end_CLT_speed_num', -50); //采集速度延长50%
    ...
    buffs[id].add_buff_value('only_start_restore', 'end_CLT_attack', 20); //采集力提高20%
    buffs[id].add_buff_value('only_start_restore', 'end_CLT_speed_num', 20); //采集间隔缩短20%
