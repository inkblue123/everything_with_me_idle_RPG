...
function init_village_backhill_map(maps) {
    ...
    //区域
    place_id = 'village_backhill'; //村外后山

    maps[id].set_area_data(600, 400);
    // maps[id].set_area_other_place('village_home', 'village_square', 'village_market', 'village_barracks', 'village_hospital');

    //战斗地点
    id = 'forest_edge_road'; //通往森林外围的道路

    maps[id].set_place_data(true);
