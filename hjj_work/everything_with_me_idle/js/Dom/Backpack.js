...
import { show_dropdown_table, change_BP_SK_IB, update_BP_value } from '../Function.js';
...
//创建左下角，角色背包物品栏界面内的详细组件
{
    ...
    //背包物品窗口
    {
        // 左侧的分类下拉表格界面
        {
            ...
            var BP_CSB_R_radio_div = addElement(BP_CSB_droptable, 'div', null, 'radio_div BP_switch_radio_div_2');
            addElement_radio(BP_CSB_R_radio_div, `BP_CSB_R`, 'BP_switch', `CSB_R`, `恢复物品`);
            var BP_CSB_B_radio_div = addElement(BP_CSB_droptable, 'div', null, 'radio_div BP_switch_radio_div_2');
            addElement_radio(BP_CSB_B_radio_div, `BP_CSB_B`, 'BP_switch', `CSB_B`, `buff物品`);
            var BP_CSB_C_radio_div = addElement(BP_CSB_droptable, 'div', null, 'radio_div BP_switch_radio_div_2');
            addElement_radio(BP_CSB_C_radio_div, `BP_CSB_C`, 'BP_switch', `CSB_C`, `战斗消耗品`);
            ...
            addElement_radio(BP_MTR_R_radio_div, `BP_MTR_R`, 'BP_switch', `MTR_R`, `原材料`);
            var BP_MTR_P_radio_div = addElement(BP_MTR_droptable, 'div', null, 'radio_div BP_switch_radio_div_2');
            addElement_radio(BP_MTR_P_radio_div, `BP_MTR_B`, 'BP_switch', `MTR_P`, `加工材料`);
