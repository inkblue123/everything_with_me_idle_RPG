...
//考古技能管理类
export class Archaeology_manage {
    constructor() {
        this.now_time; //当前时间
    ...
    //获取考古技能管理对象的存档
    save_archaeology_manage() {
        let archaeology_save = new Object();
        return archaeology_save;
    }
    //加载考古技能存档
    load_archaeology_manage(archaeology_save) {
        if (is_Empty_Object(archaeology_save)) {
            return;
        }
    }
    //更新当前地点，初始化考古信息
