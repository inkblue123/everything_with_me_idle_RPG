...
//药浴技能管理类
export class Herbal_bath_manage {
    constructor() {
        this.now_time; //当前时间
    ...
    //获取药浴技能管理对象的存档
    save_herbal_bath_manage() {
        let herbal_bath_save = new Object();
        return herbal_bath_save;
    }
    //加载药浴技能存档
    load_herbal_bath_manage(herbal_bath_save) {
        if (is_Empty_Object(herbal_bath_save)) {
            return;
        }
    }
    //更新当前地点，初始化药浴信息
